...
summon item ~ ~ ~ {Item:{id:"minecraft:command_block",Count:1b,tag:{CustomModelData:101110,lthc.magmasium_matter:1b,display:{Name:'{"translate": "Magmasium Matter","color": "#DD1111"}'}}}}
