...
execute if entity @s[tag=lthc.pig_seeds] at @s unless block ~ ~ ~ snow run function lthc.svext:custom_blocks/pig_seeds/check
execute if entity @s[tag=lthc.pig_seeds_destroy] at @s unless block ~ ~ ~ snow run function lthc.svext:custom_blocks/pig_seeds/check
