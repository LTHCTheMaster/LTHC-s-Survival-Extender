### Magmasium Ore
execute as @e[type=glow_item_frame,tag=lthc.magmasium_ore_giver] at @s run function lthc.svext:custom_blocks/magmasium_ore/place
...
### Magmasium Block
execute as @e[type=glow_item_frame,tag=lthc.lthc.magmasium_block] at @s run function lthc.svext:custom_blocks/magmasium_block/place
execute as @e[type=glow_item_frame,tag=lthc.lthc.magmasium_block_placed] at @s unless block ~ ~ ~ stone_bricks run function lthc.svext:custom_blocks/magmasium_block/destroy
