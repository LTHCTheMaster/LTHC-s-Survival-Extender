...
execute at @s if block ~ ~ ~ stone run summon glow_item_frame ~ ~ ~ {ItemRotation:0b,Tags:["lthc.magmasium_ore","lthc.destroyable","lthc.is_block"],Invisible:1b,Invulnerable:1b,Fixed:1b,Silent:1b,Facing:1b,Item:{id:"glow_item_frame",Count:1b,tag:{CustomModelData:101110}}}
execute at @s if block ~ ~ ~ stone run setblock ~ ~ ~ cobbled_deepslate

execute at @s positioned ~0.2 ~0.2 ~0.2 if block ~ ~ ~ stone run summon glow_item_frame ~ ~ ~ {ItemRotation:0b,Tags:["lthc.magmasium_ore","lthc.destroyable","lthc.is_block"],Invisible:1b,Invulnerable:1b,Fixed:1b,Silent:1b,Facing:1b,Item:{id:"glow_item_frame",Count:1b,tag:{CustomModelData:101110}}}
execute at @s positioned ~0.2 ~0.2 ~0.2 if block ~ ~ ~ stone run setblock ~ ~ ~ cobbled_deepslate

execute at @s positioned ~ ~0.2 ~0.2 if block ~ ~ ~ stone run summon glow_item_frame ~ ~ ~ {ItemRotation:0b,Tags:["lthc.magmasium_ore","lthc.destroyable","lthc.is_block"],Invisible:1b,Invulnerable:1b,Fixed:1b,Silent:1b,Facing:1b,Item:{id:"glow_item_frame",Count:1b,tag:{CustomModelData:101110}}}
...
execute at @s positioned ~ ~0.2 ~ if block ~ ~ ~ stone run summon glow_item_frame ~ ~ ~ {ItemRotation:0b,Tags:["lthc.magmasium_ore","lthc.destroyable","lthc.is_block"],Invisible:1b,Invulnerable:1b,Fixed:1b,Silent:1b,Facing:1b,Item:{id:"glow_item_frame",Count:1b,tag:{CustomModelData:101110}}}
